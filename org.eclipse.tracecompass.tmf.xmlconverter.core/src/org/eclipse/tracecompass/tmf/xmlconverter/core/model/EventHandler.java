...
/**
 * Define how an event modifies the state of the system. There should be one event handler for each event causing a state change.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="stateChange" type="{}stateChange" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "eventHandler", propOrder = {
    "stateChange"
})
